...
export PATH=$HOME/bin:/usr/local/bin:/Users/vadim/Library/Python/3.8/bin:$PATH
...
plugins=(brew compleat colorize copypath git macos nmap node pyenv python tmux virtualenv)
...
alias data="cd /Volumes/Macintosh\ Data"
